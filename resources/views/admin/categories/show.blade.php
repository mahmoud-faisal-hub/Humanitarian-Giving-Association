...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto"><a href="{{ route("category.index") }}">الأخبار</a></h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ قسم {{ $category->name }}</span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
        ...
        <div class="col-12">
            <div class="card card-table-two">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <form role="search" action="{{ route('admin.news.search', $category->id) }}" method="GET"
                ...
                <div class="table-responsive country-table mb-2 mt-3">
                    @if ($category->news->isNotEmpty())
                        <table class="table table-striped table-bordered mb-0 text-nowrap text-center align-middle">
                            ...
                            <tbody>
                                @foreach ($category->news as $_news)
                    ...
                    @else
                        <div class="card text-center">
                            <div class="card-body">
                                ...
                                <h5 class="mg-b-10 mg-t-15 tx-18">لا يوجد أخبار فى هذا القسم بعد</h5>
                            </div>
                        </div>
                    @endif
                </div>
