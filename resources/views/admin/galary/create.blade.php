...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto"><a href="{{ route("galary.index") }}">الوسائط</a></h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ إضافة وسائط</span>
						</div>
					</div>
				</div>
				<!-- breadcrumb -->
        ...
        <div class="col-12">
            <div class="card  box-shadow-0">
                <div class="card-header">
                    <h4 class="card-title mb-1">إضافة وسائط</h4>
                    <p class="mb-2">إضافة المزيد من الصور والفيديوهات</p>
                </div>
                <div class="card-body pt-0">
                    <form class="form-horizontal" method="POST" action="{{ route('galary.store') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group">
                            ...
                            <input name="galary[]" class="" type="file" id="formFile"
                                ...
                                data-max-file-size="1024MB" multiple />
                            <strong id="galary_error" class="form-text text-danger"></strong>
                        </div>
                        <div class="form-group">
                            <label for="content" class="form-label">الوصف</label>
                            <textarea name="description" class="form-control" id="content" rows="2"></textarea>
...
@section('js')
    ...
    {{-- AJAX --}}
    @include('ajax', ['url' => route('galary.store'), 'method' => 'POST', 'clear' => true])
@endsection
