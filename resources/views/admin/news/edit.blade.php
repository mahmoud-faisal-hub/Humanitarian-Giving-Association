...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto"><a href="{{ route("news.index") }}">الأخبار</a></h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ تعديل خبر</span>
						</div>
					</div>
				</div>
				<!-- breadcrumb -->
        ...
        <div class="col-12">
            <div class="card  box-shadow-0">
                <div class="card-header">
                    <h4 class="card-title mb-2">تعديل الخبر</h4>
                </div>
                <div class="card-body pt-0">
                    <form class="form-horizontal" method="POST" action="{{ route('news.update', $news->id) }}" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="article" class="form-control" id="editor" rows="10">{{ $news->article }}</textarea>
