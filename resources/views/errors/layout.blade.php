...
<html lang="en">
    <head>
        ...
        <style>
            ...
            .wrapper .container .code .content {
                width: 600px;
                height: 600px;
                display: flex;
                justify-content: center;
            ...
            .wrapper .container .code .content .piece {
                width: 200px;
                height: 80px;
                display: flex;
                position: absolute;
            ...
            .wrapper .container .code {
                ...
                position: absolute;
                z-index: 2;
                animation: error-anime 0.6s cubic-bezier(0.3, 0.8, 1, 1.05) both;
            ...
            .wrapper .container .code:nth-of-type(2) {
                color: #36184F;
                z-index: 1;
                animation-delay: 1s;
                filter: blur(10px);
        ...
        <section class="wrapper">
            ...
            <div class="container">
                ...
                <div id="scene" class="scene" data-hover-only="false">
                    ...
                    <p class="code" data-depth="0.50">@yield('code')</p>
                    <p class="code" data-depth="0.10">@yield('code')</p>
